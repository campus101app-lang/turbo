// lib/screens/merchant/checkout_screen.dart
import 'dart:async';
import 'dart:ui';
...
// ─── Cart provider (simple ephemeral state) ───────────────────────────────────
...
class _CheckoutScreenState extends ConsumerState<CheckoutScreen> {
  ...
  Future<void> _startNfc() async {
    ...
    try {
      await NfcManager.instance.startSession(
        ...
        // Fix: Use an empty set or specific options instead of null
  ...
  Widget build(BuildContext context) {
    if (_paymentReceived) return _buildPaidScreen(context);
  ...
  Widget _buildPaidScreen(BuildContext context) {
    return AppBackground(
      child: Scaffold(
        backgroundColor: Colors.transparent,
        body: SafeArea(
